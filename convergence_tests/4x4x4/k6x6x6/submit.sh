...
#SBATCH --output=fe_bulk_4x4x4_k666_%j.slurm.out
#SBATCH --error=fe_bulk_4x4x4_k666_%j.slurm.err
#SBATCH --mem=500G
# Using 128 MPI tasks for 128 atoms.
